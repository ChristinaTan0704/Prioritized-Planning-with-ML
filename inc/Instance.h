...
public:
	...
	Instance(){}
	Instance(const string& map_fname, const string& agent_fname, bool first_agents,
		int num_of_agents = 0, bool generate_agents = false, bool save_agents = true,
...
private:
    ...
    bool loadAgents(bool first_agents);
